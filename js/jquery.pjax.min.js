 ...
 */
 !function(v) {
    ...
    function a(t, e, n) {
        ...
        if (!(1 < t.which || t.metaKey || t.ctrlKey || t.shiftKey || t.altKey || location.protocol !== a.protocol || location.hostname !== a.hostname || -1 < a.href.indexOf("#") && c(a) == c(location) || t.isDefaultPrevented())) {
            var i = {
                    url: a.href,
            ...
            r.trigger(s, [o]),
            s.isDefaultPrevented() || (x(o), t.preventDefault(), r.trigger("pjax:clicked", [o]))
        }
    }
    function e(t, e, n) {
        n = u(e, n);
    ...
    function x(d) {
        ...
        d.beforeSend = function(t, e) {
            if ("GET" !== e.type && (e.timeout = 0), t.setRequestHeader("X-PJAX", "true"), t.setRequestHeader("X-PJAX-Container", d.container), !m("pjax:beforeSend", [t, e]))
                return !1;
        ...
        d.success = function(t, e, n) {
            var a = x.state,
                ...
                o = T(t, n, d),
                s = b(o.url);
            if (f && (s.hash = f, o.url = s.href), r && i && r !== i)
                g(o.url);
            else if (o.contents) {
                if (x.state = {
                    id: d.id || j(),
                    ...
                    fragment: d.fragment,
                    timeout: d.timeout
                }, (d.push || d.replace) && window.history.replaceState(x.state, o.title, o.url), v.contains(h, document.activeElement))
                    try {
                ...
                h.html(o.contents);
                var c = h.find("input[autofocus], textarea[autofocus]").last()[0];
                ...
                if (f) {
                    var l = decodeURIComponent(f.slice(1)),
                        p = document.getElementById(l) || document.getElementsByName(l)[0];
                    p && (u = v(p).offset().top)
                }
        ...
        var e,
            n,
            r = x.xhr = v.ajax(d);
        return 0 < r.readyState && (d.push && !d.replace && (e = x.state.id, n = [d.container, w(h)], E[e] = n, P.push(e), C(S, 0), C(P, x.defaults.maxCacheLength), window.history.pushState(null, "", d.requestUrl)), m("pjax:start", [r, d]), m("pjax:send", [r, d])), x.xhr
    }
    function n(t, e) {
        var n = {
            url: window.location.href,
            ...
            if (o.length) {
                n && function(t, e, n) {
                    var a,
                        r;
                    E[e] = n,
                    "forward" === t ? (a = P, r = S) : (a = S, r = P);
                    a.push(e),
                    (e = r.pop()) && delete E[e];
                    C(a, x.defaults.maxCacheLength)
                }(e, n.id, [i, w(o)]);
                var c = v.Event("pjax:popstate", {
                    state: a,
                    direction: e
                });
                o.trigger(c);
    ...
    function T(t, e, n) {
        ...
        if (i.url = s ? l(b(s)) : n.requestUrl, o) {
        ...
        if (0 === r.length)
            return i;
        if (i.title = f(a, "title").last().text(), n.fragment) {
            var u = r;
        ...
        }), i.contents.find("title").remove(), i.scripts = f(i.contents, "script[src]").remove(), i.contents = i.contents.not(i.scripts)), i.title && (i.title = v.trim(i.title)), i
    }
    r && r.container && (x.state = r),
